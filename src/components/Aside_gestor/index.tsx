        ...
        <div className="posicionamento_elementos" id="posicao">
              ...
              <ul>
                ...
                <li>
                  <a href="../gestaoColaboradorGestor/index.html">
                    <div>
                      <img className="icon" src={gestao} alt="icone agenda" />
                    </div>
                ...
                <li>
                  <a href="../_gestaoDeConteudo/index.html">
                    <div>
                      <img className="icon" src={livro} alt="icone agenda" />
                    </div>
                ...
                <li>
                  <a href="../cadastro_colaborador_gestor/index.html">
                    <div>
                      <img className="icon" src={cadastro} alt="icone agenda" />
                    </div>
                ...
                <li>
                  <a href="../cadastroDeConteudos/index.html">
                    <div>
                      <img className="icon" src={conteudo} alt="icone agenda" />
                    </div>
                ...
                <li>
                  <a href="../editarAgendaColaboradorIngressante/index.html">
                    <div>
                      <img className="icon" src={agenda} alt="icone agenda" />
                    </div>
                ...
                <li>
                  <a href="../trilhaDeConteudo/index.html">
                    <div>
                      <img className="icon" src={check} alt="icone agenda" />
                    </div>
          ...
          <div className="div_logofirst">
            <a href="/login/login.html">
              <img className="saida" src={saida} alt="icone saida" />
            </a>
