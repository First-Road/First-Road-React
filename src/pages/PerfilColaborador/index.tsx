...
function PerfilColaborador() {
  ...
  function CadastrarColaborador(event: React.FormEvent) {
  ...
  return (
    <main id="aside_colaborador">   
       <Aside/>
      <section className="ColaboradorPerfil">
        <div className="ColaboradorPerfil_Secao">
          <h1>Perfil Colaborador</h1>
          <div className="user_config">
            <img
              className="Colaborador_FotoPadrao"
              src={FotoPerfil}
              alt=""
            />

            <svg
              className="Colaborador_engrenagem"
          ...
          <div className="ColaboradorPerfil_texto_imagem">
